        ...
        <div class="offcanvas offcanvas-start site-offcanvas" tabindex="-1" id="siteMenu" aria-labelledby="siteMenuLabel" data-bs-scroll="true">
            ...
            <div class="offcanvas-body">
                <nav class="site-menu" aria-label="Hauptmenü">
                    ...
                    <a class="site-menu-link site-menu-link--leaf" href="team.html"><span class="site-menu-bullet" aria-hidden="true"><i class="bi bi-chevron-double-right" aria-hidden="true"></i></span><span class="site-menu-text">Team</span></a>

    <div class="site-menu-section">Suche</div>
                                        <a class="site-menu-link site-menu-link--leaf" href="person_search.html"><span class="site-menu-bullet" aria-hidden="true"><i class="bi bi-chevron-double-right" aria-hidden="true"></i></span><span class="site-menu-text">Personensuche</span></a>
                    <!-- <a class="site-menu-link" href="search.html">Volltextsuche</a> -->
                                        <a class="site-menu-link site-menu-link--leaf" href="./nosketch.html?corpname=flugblaetter&amp;q=q%3Cdoc%3E%22.*%22+&amp;viewmode=kwic&amp;attrs=word%2Clemma%2Cpos%2Cvocab%2Cid&amp;format=json&amp;structs=doc%2Chead%2Cp%2Clg%2Cl%2CplaceName%2Cquote%2Cbibl%2CpersName%2Cdate%2Ccit%2Cg&amp;kwicrightctx=45%23&amp;kwicleftctx=45%23&amp;refs=doc.id%2Cl.id%2Cp.id%2CplaceName.id%2CpersName.id%2Cdate.id%2Cdoc.title%2Cdoc.delinquent_sexes%2Cdoc.attrs%2Clg.type&amp;pagesize=10&amp;fromp=1&amp;selectQueryValue=url"><span class="site-menu-bullet" aria-hidden="true"><i class="bi bi-chevron-double-right" aria-hidden="true"></i></span><span class="site-menu-text">Volltextsuche/Linguistische Suche</span></a>
                    ...
                    <a class="site-menu-link site-menu-link--leaf" href="imprint.html"><span class="site-menu-bullet" aria-hidden="true"><i class="bi bi-chevron-double-right" aria-hidden="true"></i></span><span class="site-menu-text">Impressum</span></a>
                    <a class="site-menu-link site-menu-link--leaf" href="imprint.html"><span class="site-menu-bullet" aria-hidden="true"><i class="bi bi-chevron-double-right" aria-hidden="true"></i></span><span class="site-menu-text">Datenschutzt</span></a>
