...
<xsl:stylesheet xmlns:tei="http://www.tei-c.org/ns/1.0"
    ...
    <xsl:param name="project_title">Armesünderblätter</xsl:param>
    <xsl:param name="redmine_id">22952</xsl:param>
    <xsl:param name="project_short_title">Armesünderblätter</xsl:param>
    <xsl:param name="github_url">https://github.com/Flugblatter/flugblaetter_static</xsl:param>
    <xsl:param name="html_title">Armesünderblätter</xsl:param>
    <xsl:param name="project_logo">images/logo.png</xsl:param>
    <xsl:param name="base_url">http://url-of-my-awesome-site</xsl:param>
    <xsl:param name="data_repo">https://github.com/acdh-oeaw/dse-static-cookiecutter/dse-static-data</xsl:param>
</xsl:stylesheet>